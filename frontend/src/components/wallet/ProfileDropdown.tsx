...
import { useWallet, useWeb3Ready } from '@/lib/wagmi';
...
export const ProfileDropdown: React.FC = () => {
  const isWeb3Ready = useWeb3Ready();
  const { 
    isConnected, 
    isConnecting, 
    walletAddress, 
  ...
  // If Web3 is not ready yet, show loading placeholder
  if (!isWeb3Ready) {
    return <div style={{ width: 120, height: 40, background: '#f5f7fa', borderRadius: 6 }} />;
  }
